...
<tr><td>§Keywords for creating automatic records on EPG import (comma separated, case ignored)§</td><td><input type="text" maxlength="120" id="cfg_epg_autorecord" class="text ui-widget-content ui-corner-all" /></td></tr>
